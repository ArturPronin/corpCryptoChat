...
public class Botfragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_bot, null);
        //getSupportActionBar().setTitle("Чат-бот");

        controller = new MessageController();
        contacts = view.findViewById(R.id.contacts);
        library = view.findViewById(R.id.library);
        openSite = view.findViewById(R.id.openSite);
        myTasks = view.findViewById(R.id.myTasks);
        mySchedule = view.findViewById(R.id.mySchedule);
        moneyInfo = view.findViewById(R.id.buttonMoneyInfo);
        chatWindow = view.findViewById(R.id.chatBotWindow);
